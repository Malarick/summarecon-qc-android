...
public class CalendarAdapter extends BaseAdapter {
    ...
    public GregorianCalendar pmonth; // fragment_schedule instance for previous month
    /**
     * fragment_schedule instance for previous month for getting complete view
     */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        calendar_layout = v.findViewById(R.id.calender_block);
    ...
    public void refreshDays() {
        ...
        calMaxP = maxP - (firstDay - 1);// fragment_schedule offday starting 24,25 ...
        /**
        ...
        /**
         * filling fragment_schedule gridview.
         */
